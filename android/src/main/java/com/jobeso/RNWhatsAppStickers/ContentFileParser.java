...
class ContentFileParser {
    ...
    private static StickerPack readStickerPack(@NonNull JsonReader reader) throws IOException, IllegalStateException {
        ...
        while (reader.hasNext()) {
            ...
            switch (key) {
                ...
                case "stickers":
                    ...
                    break;
                case "image_data_version":      // #373
                    imageDataVersion = reader.nextString();
                    break;
                case "avoid_cache":     // #373
                    avoidCache = reader.nextBoolean();
                    break;
                case "animated_sticker_pack":       // #373
        ...
        reader.endObject();
        final StickerPack stickerPack = new StickerPack(identifier, name, publisher, trayImageFile, publisherEmail, publisherWebsite, privacyPolicyWebsite, licenseAgreementWebsite,imageDataVersion, avoidCache, animatedStickerPack); // #373
